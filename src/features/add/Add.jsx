...
const Add = () => {
  return (
    <div class="add" className="flex justify-center">
      <div class="container" className="w-[600] p-9 md:w-[1400px] overflow-hidden">
        <h1 className="font-amaze w-full font-semibold text-[22px] ">Add New Gig</h1>
        <div class="sections" className="flex flex-col gap-10 md:gap-24">
          <div class="info" className="flex flex-col gap-3">
          ...
          <div class="details" className=" flex flex-col gap-3">
